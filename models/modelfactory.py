...
def resnet20(input_size, num_classes=10):
    """Constructs a ResNet-20 model for CIFAR-10 (by default)
    Args:
      num_classes (uint): number of classes
    """
    model = CifarResNet(ResNetBasicblock, 20, num_classes,input_size=input_size)
    return model
...
def MaskedDocumentResnet(num_classes, numInputChannels, input_size):
    net = resnet20(input_size, num_classes).float()
